...
g.width,f=g.height;e>f?e>b&&(f=Math.round(f*=b/e),e=b):f>d&&(e=Math.round(e*=d/f),f=d);a.width=e;a.height=f;a.getContext("2d").drawImage(g,0,0,e,f);return a.toDataURL(c,h).replace("data:image/png;base64,","")}},Ajax={url:{version:Constant.hostname+"/version/update.json",upload:Constant.hostname+"/upload",clientLogin:Constant.hostname+"/pub/client/app/login",clientRegister:Constant.hostname+"/pub/client/app/register",topicTypeList:Constant.hostname+"/bbs/topictype/app/list"},timeout:2E4,ajax:function(a,
c,b,d,h,g,e){d=d||function(a,b,c){mui.plusReady(function(){plus.nativeUI.toast(b)})};h=h||function(a,b,c){mui.plusReady(function(){plus.nativeUI.closeWaiting();plus.nativeUI.toast(b)})};mui.ajax(a,{type:c||"POST",data:b||{},dataType:g||"json",success:function(a){a.success?d(a.data):e?e(a.message):mui.plusReady(function(){plus.nativeUI.toast(a.message)})},error:h,timeout:Ajax.timeout})},post:function(a,c,b){Ajax.ajax(a,"POST",c,b,mui.noop(),"json")},get:function(a,c,b){Ajax.ajax(a,"GET",c,b,mui.noop(),
"json")},isEmpty:function(a){return null==a||""==a||"null"==a||void 0==a}};
